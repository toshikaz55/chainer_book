...
class DCGAN_Generator_NN(chainer.Chain):
    ...
    def __init__(self):
        ...
        with self.init_scope():
            self.l0 = L.Linear( 100, neuron_size * image_size * image_size // 8 // 8, initialW=w)
...
updater = DCGANUpdater(train_iter, {'opt_gen':optimizer_gen, 'opt_dis':optimizer_dis}, device = uses_device)
